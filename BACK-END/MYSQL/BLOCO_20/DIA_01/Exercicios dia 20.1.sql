...
SELECT 
    ...
    ROUND(SUM(salary), 2) AS 'soma_de_todos_salários',
...
SELECT 
    department_id,
    AVG(SALARY),
    COUNT(*) 'number_of_employes'
FROM
    employees
GROUP BY department_id
HAVING 'number_of_employes' > 10;
...
SELECT 
    first_name, last_name, DATEDIFF(CURRENT_DATE, hire_date ) AS 'tempo_de_empresa_em_dias'
FROM
    employees;
